...
const noAccountEmbed = new EmbedBuilder().setColor("#d1390f").addFields({
  name: "Error Status",
  value:
    "```ansi\n\u001b[2;31m" +
...
const maintenanceEmbed = new EmbedBuilder().setColor("#d1390f").addFields({
...
const errorEmbed = new EmbedBuilder().setColor("#d1390f").addFields({
  name: "Error Status",
  value:
    "```ansi\n\u001b[2;31m" +
...
const noStatsEmbed = new EmbedBuilder().setColor("#d1390f").addFields({
  name: "Error Status",
  value:
    "```ansi\n\u001b[2;31m" +
...
const helpEmbed = new EmbedBuilder().setColor("#6c71c4").addFields(
  {
    name: "\u200B",
    value:
      "```ansi\n\u001b[0;45m" +
...
function linkEmbed(args) {
  return new EmbedBuilder().setColor(Colors.Green).addFields({
    name: "Success!",
    value:
...
const unlinkEmbed = new EmbedBuilder().setColor(Colors.Green).addFields({
  name: "Success!",
  value:
...
const noLinkEmbed = new EmbedBuilder().setColor("Random").addFields({
  name: "Error Status",
  value:
...
const voteEmbed = new EmbedBuilder().setColor("#FFAA20").addFields({
  name: "Alert Status",
  value:
